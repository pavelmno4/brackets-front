				...
				<label for="data-processing-consent">
					<details>
						...
						<p class="data-processing-consent-text">
							...
							обработку моих персональных данных, включающих фамилию, имя, отчество, дату рождения,
							пол в целях осуществления процесса организации турнира. Предоставляю веб-ресурсу
